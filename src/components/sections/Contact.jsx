...
export default function Contact() {
  ...
  useScrollReveal(['#contact-title', '#contact-title + p', '#form div', '#form button'], {
    origin: 'bottom',
    distance: '50px',
  });
  ...
  function handleSubmit(e) {
    ...
    if (Object.values(validate).every((e) => e)) {
      fetch('https://formsubmit.co/ajax/castaneda30@hotmail.com', {
        method: 'POST',
        headers: {
  ...
  return (
    <Section id='contact'>
      ...
      <StyledForm onSubmit={handleSubmit} sent={sent} id='form'>
        <div>
          <input type='text' id='name' name='name' title={form.name} required autoComplete='none' />
